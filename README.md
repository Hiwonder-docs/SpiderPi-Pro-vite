# SpiderPi_Pro Documentation

This repository contains the SpiderPi_Pro VitePress documentation site. The
...
The staged production files are generated in `projects/SpiderPi_Pro/en/latest/`.
...
```text
https://hiwonder-docs.github.io/SpiderPi_Pro-vite/projects/SpiderPi_Pro/en/latest/
```

The public-facing URL (via the baota Nginx reverse proxy) is:

```text
https://wiki-test.hiwonder.com/projects/SpiderPi_Pro/en/latest/
```
